...
begin
	...
	add_round_key_inst : entity work.inv_add_round_key
		port map(
			input1 => reg_output,
			input2 => round_key,
	...
	inv_sub_byte_inst : entity work.inv_sub_byte
	 ...
	 -- Keyschedule 
	 key_schedule_inst : entity work.inv_key_schedule
	 	port map(
	 		clk         => clk,
	 		rst         => rst,
	 		key         => dec_key,
	 ...
	 -- Controller
	 controller_inst : entity work.inv_controller
	 	port map(
	 		clk            => clk,
	 		rst            => rst,
	 		rconst         => round_const,
