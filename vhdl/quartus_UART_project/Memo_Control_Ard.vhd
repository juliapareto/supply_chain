...
end Memo_Control_Ard;

architecture Behavioral of Memo_Control_Ard is

    type t_State is (RECEIVING, SHOWING_LEDS, SENDING_TX);
        ...
        if reset = '0' then
            ...
            case r_State is
                ...
                when SENDING_TX =>
                    ...
                    if r_TX_DV = '0' and i_TX_Active = '0' and r_Waiting_For_Next_Byte = '0' then
                    ...
                    elsif (i_TX_Done = '1' and i_TX_Active = '0') or r_Waiting_For_Next_Byte = '1' then
                        ...
                        if r_Counter = g_CLKS_PER_SECOND - 1 then
                            ...
                            if r_Send_Index = g_NUM_BYTES - 1 then
                                r_Send_Index <= 0;
                                r_State <= RECEIVING; -- Loop back to receive again
                            else
