...
entity UART_MEMO_Top_ARDUINO_SEND is
    port (
        i_Clk       : in  std_logic;
		  reset		  : in  std_logic;
...
end UART_MEMO_Top_ARDUINO_SEND;

architecture Structural of UART_MEMO_Top_ARDUINO_SEND is
...
--		  s_SW_vector(7) <= i_SW_7;
    ...
    -- MEMORY BLOCK
    Memo_Control_inst : entity work.Memo_Control_Ard_SEND
        generic map (
            g_NUM_BYTES => 2
